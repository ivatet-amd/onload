...
static struct hugetlb_allocator *efct_hugetlb_alloc = NULL;

void efct_provide_hugetlb_alloc(struct hugetlb_allocator *hugetlb_alloc)
{
                               ...
                               struct efct_client_hugepage *result_out)
{
  ...
  rc = hugetlb_page_alloc_raw(efct_hugetlb_alloc,
...
{
  hugetlb_page_free_raw(mem->file, mem->page);
}
